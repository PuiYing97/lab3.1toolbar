    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            if (size < max) {
                ...
                Toast.makeText(getApplicationContext(), "This is a max size",
                        Toast.LENGTH_SHORT).show();
            }
            else if (id == R.id.action_settings) {
                //TODO satrt the ABOUT Activity
                Intent intent = new Intent(this, AboutActivity.class);
                startActivity(intent);
            }
        }
             if( id == R.id.action_decrease){
            //TODO start the decrease activity
            if(size > min){
                size --;
                textViewMessage.setTextSize(size);
            }else{
                //getAppplicationContext() = this
                Toast.makeText(getApplicationContext(),"This is a min size",
